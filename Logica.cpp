...
void agregarArribo(string idPuerto, string idBarco, float cargaDespacho)
{
  ...
  if (barcoObj == NULL){
    cout << "es pasajero, como el amor";
  }else{
    cout << "\n carga: " << barcoObj->getCarga() << "\n capacidad: " << barcoObj->getCapacidad() << "\n cargaDespacho: " << cargaDespacho;
    cout << "\n carga - despacho = " << barcoObj->getCarga() - cargaDespacho;;
  }
